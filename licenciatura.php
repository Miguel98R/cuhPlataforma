...
<div class="container">
  ...
  <div class="menuAboutUs text-center" style="box-shadow: 1px 2px 16px -2px rgba(0,0,0,0.75);">
    ...
    <div class="view overlay px-2 py-2">
      <img style="width: 100%; height: 630px;"class="card-img-top" src="img/licenciatura3.jpg  "alt="Card image cap">
      <a href="#!">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 py-2 d-flex justify-content-center">
                    <div class="card  danger-color-dark" style="width: 18rem;">
                      <a href=""><img class="card-img-top px-3 py-1" src="img/sistemas.png" alt="Card image cap"></a> 
                  ...
                  <div class="col-md-6 py-2 py-2 d-flex justify-content-center">
  ...
  <div class="card-body blue-grey darken-3">
    ...
    <h3 class="text-white font-weight-bold">Ciencias de la educación</h3>
        ...
        <div class="container">
                   ...
                   <p> <strong class="font-weight-bold">Tipo de Ciclo:</strong> Bimestral</p>
                        <p><strong  class="font-weight-bold">Duración del Ciclo Mat - Vesp:</strong> 3 Años y medio</p>
                        <p> <strong  class="font-weight-bold">Duración del Ciclo Mixto: </strong> 4 Años</p>
                    </div>
                </div>
